        ...
        <div class="layuimini-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;">
                        <%
                           /* JS user=(Map)request.getSession().getAttribute("user");*/
                        %>
                        <c:choose>
                    ...
                    <dl class="layui-nav-child">
                       <!-- <dd>
                        ...
                        <dd>
                            <a href="javascript:void(0)" layuimini-content-href="/layuimini-2/page/modify_admin_password.html" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin', 'miniTongji'], function () {
        ...
        var options = {
            iniUrl: "/admin/menu?action=init",   // 初始化接口
       ...
       /* miniTongji.render({
        ...
        $('.login-out').on("click", function () {
            layer.confirm("确定退出登录吗?",function (){
                var str={action:"logout"};
                str=JSON.stringify(str);
                var domain=document.domain;
                domain="http://"+domain+"/admin_login";
                $.ajax({
                    type:"POST",
                    url:domain,
                    data:str,
